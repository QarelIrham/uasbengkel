...
class _FormEntryPageState extends State<FormEntryPage> {
  ...
  child: Container(
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(12),  // Optional, agar tombol punya sudut melengkung
    ),
    child: ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        backgroundColor: Colors.transparent, // Membuat latar belakang tombol transparan agar gradasi terlihat
